...
function validatePlanet(planet)
{
    if (!planet.position)
    {
        if (!_.has(planet, 'position_x') || !_.has(planet, 'position_y'))
            return "No position";
    ...
    if (!planet.velocity)
    {
        if (!_.has(planet, 'velocity_x') || !_.has(planet, 'velocity_y'))
            return "No velocity";
...
exports.validateSystemConfig = function(systemConfig) {
    ...
    if (planets.length > exports.MAX_PLANETS)
